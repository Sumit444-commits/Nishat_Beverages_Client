...
//                    (s.paymentMethod === 'Pending' && s.amountReceived > 0 && paymentMethodFilter === 'Cash');
//         });
...
//     const periodButtons = ['Today', 'This Month', 'This Year', 'Custom'];
...
//                 <p className="text-brand-text-secondary mt-1">Finalize financial records for: <span className="font-semibold">{previousMonthData.periodName}</span>.</p>
//                 <div className="mt-4">
//                     <button 
...
//                 <h2 className="text-2xl font-bold text-brand-text-primary">Closing Summary</h2>
//                 <p className="text-brand-text-secondary">Period: {activePeriod} | Method: {paymentMethodFilter}</p>
//             </div>
...
//                         <p className="text-sm font-semibold text-orange-600">Cash: PKR {stats.cashExpenses.toLocaleString()}</p>
//                         <p className="text-sm font-semibold text-orange-600">Bank: PKR {stats.bankExpenses.toLocaleString()}</p>
//                     </div>
//                 </div>
...
//                     <div className="text-[10px] uppercase font-bold text-indigo-400 mt-2 space-y-1">
//                         <p>Total Rev: PKR {stats.totalRevenue.toLocaleString()}</p>
//                         <p>Total Exp: PKR {stats.totalExpenses.toLocaleString()}</p>
//                     </div>
//                 </div>
//             </div>
...
//                             {Object.entries(stats.expensesByCategory).map(([category, amounts]) => (
//                                 <div key={category} className="border rounded-lg p-4 bg-white shadow-sm">
//                                     <h4 className="font-semibold text-brand-text-primary mb-2 border-b pb-1">{category}</h4>
//                                     <div className="space-y-1 text-sm">
//                                         <div className="flex justify-between text-brand-text-secondary">
//                                             <span>Cash:</span>
//                                             <span>PKR {amounts.cash.toLocaleString()}</span>
//                                         </div>
//                                         <div className="flex justify-between text-brand-text-secondary">
//                                             <span>Bank:</span>
//                                             <span>PKR {amounts.bank.toLocaleString()}</span>
//                                         </div>
//                                         <div className="flex justify-between pt-1 border-t font-bold text-brand-text-primary">
//                                             <span>Total:</span>
//                                             <span>PKR {amounts.total.toLocaleString()}</span>
//                                         </div>
//                                     </div>
//                                 </div>
//                             ))}
...
//                         <h3 className="font-bold text-brand-text-primary">Sales Details</h3>
//                     </div>
//                     <div className="overflow-x-auto p-4">
//                         {filteredData.filteredSales.length > 0 ? (
//                              <table className="w-full text-xs text-left">
//                                 <thead className="text-brand-text-secondary border-b">
//                                     <tr>
...
//                                             <td className="py-2 font-medium">{getCustomerName(sale.customerId)}</td>
//                                             <td className="py-2 text-center">{sale.quantity}</td>
//                                             <td className="py-2 text-center">
//                                                 <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${sale.paymentMethod === 'Cash' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'}`}>
//                                                     {sale.paymentMethod}
//                                                 </span>
//                                             </td>
//                                             <td className="py-2 text-right font-bold">{sale.amountReceived.toLocaleString()}</td>
//                                         </tr>
//                                     ))}
//                                 </tbody>
//                             </table>
//                         ) : <p className="text-center text-gray-400 py-4">No sales records.</p>}
//                     </div>
//                 </div>
...
//                         <h3 className="font-bold text-brand-text-primary">Expense Details</h3>
//                     </div>
//                      <div className="overflow-x-auto p-4">
...
//                                                 </span>
//                                             </td>
//                                             <td className="py-2 text-right font-bold text-red-600">{expense.amount.toLocaleString()}</td>
//                                         </tr>
//                                     ))}
//                                 </tbody>
//                             </table>
//                         ) : <p className="text-center text-gray-400 py-4">No expense records.</p>}
//                     </div>
//                 </div>
//             </div>
...
//                 <div className="p-4 bg-gray-50 border-b">
//                      <h3 className="font-bold text-brand-text-primary uppercase text-sm tracking-wider">Historical Monthly Closings</h3>
//                 </div>
//                 <div className="overflow-x-auto">
//                     <table className="w-full text-sm text-left">
//                         <thead className="bg-gray-100 text-brand-text-secondary uppercase text-xs">
//                             <tr>
//                                 <th className="px-6 py-3">Period</th>
//                                 <th className="px-6 py-3">Cash Rev</th>
//                                 <th className="px-6 py-3">Bank Rev</th>
...
//                                     <td className="px-6 py-4 font-bold text-brand-text-primary">{record.period}</td>
...
//                                     <td className="px-6 py-4 text-red-600 font-medium">PKR {(record.cashExpenses + record.bankExpenses).toLocaleString()}</td>
//                                     <td className={`px-6 py-4 font-bold ${record.netBalance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
//                                         PKR {record.netBalance.toLocaleString()}
//                                     </td>
//                                 </tr>
//                             )) : (
//                                 <tr>
