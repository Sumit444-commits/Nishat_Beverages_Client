...
//  * @param {Object} props
//  * @param {Object} props.item - The inventory item object.
...
//                 <button 
//                     onClick={onBack} 
//                     className="flex items-center text-sm font-semibold text-brand-text-secondary hover:text-brand-blue mb-2 transition-colors"
//                 >
//                     <ArrowLeftIcon className="h-4 w-4 mr-2" />
//                     Back to Inventory
//                 </button>
//                 <h1 className="text-3xl font-bold text-brand-text-primary">{item.name}</h1>
//                 <p className="text-brand-text-secondary font-medium italic">Category: {item.category}</p>
//             </div>
...
//                 <StatCard 
//                     title="Selling Price" 
//                     value={`PKR ${item.sellingPrice.toLocaleString()}`} 
//                     icon={<DollarSignIcon />} 
//                 />
//                 <StatCard 
//                     title="Current Stock Value" 
//                     value={`PKR ${(item.stock * item.sellingPrice).toLocaleString()}`} 
//                     icon={<BarChartIcon />} 
//                 />
//             </div>
...
//                 {/* Sales History Table */}
//                 <div className="bg-brand-surface rounded-xl shadow-md overflow-hidden flex flex-col">
...
//                                             </td>
//                                             <td className="px-6 py-4 font-bold">{sale.quantity}</td>
...
//                                                 {adj.reason}
//                                             </td>
//                                             <td className={`px-6 py-4 font-bold ${adj.quantity > 0 ? 'text-green-600' : 'text-red-600'}`}>
...
//             <div className="bg-brand-surface rounded-xl shadow-md p-6 border border-dashed border-gray-300">
//                 <h2 className="text-xl font-bold text-brand-text-primary">Supplier Information</h2>
//                 <p className="text-brand-text-secondary mt-2 italic">
//                     Supplier details and procurement history for this item are not yet available.
//                 </p>
//             </div>
//         </div>
//     );
