...
//  * @param {Object} props
//  * @param {Array} props.customers - The list of customer objects to display.
...
//                                         customer.totalBalance > 0 ? 'text-yellow-600' : 'text-green-600'
//                                     }`}>
//                                         {customer.totalBalance.toLocaleString()}
//                                     </td>
//                                      <td className={`px-6 py-4 font-semibold ${
//                                          customer.emptyBottlesHeld > 5 ? 'text-red-600' : 'text-brand-text-primary'
//                                      }`}>
//                                         {customer.emptyBottlesHeld}
//                                     </td>
//                                     <td className="px-6 py-4">
//                                         <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
//                                             deliveryDue ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'
//                                         }`}>
...
//                                                 className="bg-green-500 text-white px-3 py-1 rounded-md text-xs font-semibold hover:bg-green-600 transition-colors shadow-sm"
//                                             >
//                                                 Sale
//                                             </button>
//                                              <button
//                                                 onClick={() => onCollectEmpties(customer)}
//                                                 className="bg-blue-500 text-white px-3 py-1 rounded-md text-xs font-semibold hover:bg-blue-600 transition-colors flex items-center shadow-sm"
//                                             >
...
//                                                 className="font-medium text-sm text-brand-blue hover:text-brand-lightblue transition-colors"
//                                             >
//                                                 Edit
//                                             </button>
//                                             <button 
...
//             </div>
//              {customers.length === 0 && (
//                 <div className="text-center py-10 px-6 text-brand-text-secondary italic">
