...
//                 case 'totalBalance':
//                 default:
//                     valA = a.totalBalance || 0;
//                     valB = b.totalBalance || 0;
//                     break;
//             }
...
//         customers.reduce((sum, c) => sum + (c.totalBalance || 0), 0), 
//     [customers]);
...
//                  <div className="p-4 rounded-xl bg-yellow-100 text-yellow-800 border border-yellow-200 shadow-sm">
//                      <span className="text-sm font-medium uppercase tracking-wider">Total Receivables:</span>
//                      <span className="font-bold text-2xl ml-3">PKR {totalOutstanding.toLocaleString()}</span>
//                  </div>
//             </div>
...
//                         className="w-full md:w-1/3 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-blue transition-all"
//                     />
//                 </div>
...
//                             <tr>
//                                 <th scope="col" className="px-6 py-4 cursor-pointer hover:text-brand-blue transition-colors" onClick={() => handleSort('name')}>
//                                     Name {sortKey === 'name' && (sortDirection === 'asc' ? '↑' : '↓')}
//                                 </th>
//                                 <th scope="col" className="px-6 py-4 cursor-pointer hover:text-brand-blue transition-colors" onClick={() => handleSort('address')}>
//                                     Address {sortKey === 'address' && (sortDirection === 'asc' ? '↑' : '↓')}
//                                 </th>
//                                 <th scope="col" className="px-6 py-4">Mobile</th>
//                                 <th scope="col" className="px-6 py-4 cursor-pointer text-right hover:text-brand-blue transition-colors" onClick={() => handleSort('totalBalance')}>
//                                     Balance (PKR) {sortKey === 'totalBalance' && (sortDirection === 'asc' ? '↑' : '↓')}
//                                 </th>
//                                 <th scope="col" className="px-6 py-4 text-center">Reminders</th>
//                             </tr>
//                         </thead>
//                         <tbody className="divide-y divide-gray-100">
//                             {sortedCustomers.map(customer => (
//                                 <tr key={customer.id} className="bg-white hover:bg-gray-50 transition-colors">
//                                     <td className="px-6 py-4 font-bold text-brand-text-primary">{customer.name}</td>
...
//                                             className="flex items-center justify-center mx-auto bg-green-500 text-white px-4 py-1.5 rounded-lg text-xs font-bold hover:bg-green-600 transition-all shadow-sm active:scale-95"
//                                         >
...
//                     <div className="text-center py-16 px-6 text-brand-text-secondary italic bg-white">
