...
//     // Type generics removed; JavaScript handles these as mutable refs
...
//         const pendingBalances = customers.reduce((sum, c) => sum + (c.totalBalance || 0), 0);
...
//                     ) : (
//                         <p className="text-center text-brand-text-secondary pt-16 italic">
