...
//  * @param {Object} props
//  * @param {Array} props.salesmen - List of salesman objects.
...
//                             <th scope="col" className="px-6 py-3 font-bold">Mobile</th>
//                             <th scope="col" className="px-6 py-3 font-bold">Hire Date</th>
//                             <th scope="col" className="px-6 py-3 font-bold">Customers Assigned</th>
//                             <th scope="col" className="px-6 py-3 font-bold">Quantity Sold Today</th>
//                             <th scope="col" className="px-6 py-3 text-center font-bold">Actions</th>
//                         </tr>
//                     </thead>
//                     <tbody>
//                         {salesmen.length > 0 ? salesmen.map((salesman) => (
//                             <tr key={salesman.id} className="bg-white border-b hover:bg-gray-50 transition-colors">
...
//                                     {salesman.customersAssigned}
//                                 </td>
//                                 <td className="px-6 py-4 font-bold text-brand-blue">
//                                     {salesman.quantitySoldToday}
//                                 </td>
//                                 <td className="px-6 py-4">
...
//                                         <button 
//                                             onClick={() => {
//                                                 if(window.confirm(`Are you sure you want to delete ${salesman.name}?`)) {
//                                                     onDeleteSalesman(salesman.id);
//                                                 }
//                                             }} 
...
//                                         <button 
//                                             onClick={() => onViewDetails(salesman)} 
//                                             className="font-bold text-xs text-brand-blue hover:underline uppercase tracking-tighter"
//                                         >
//                                             Details
//                                         </button>
//                                     </div>
...
//                                     No salesmen found. Click "Add Salesman" to register your staff.
//                                 </td>
//                             </tr>
//                         )}
//                     </tbody>
