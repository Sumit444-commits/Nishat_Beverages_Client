...
//  * @param {boolean} [props.isHighlighted=false] - Apply a yellow warning background (for differences).
//  */
...
//     isHighlighted = false,
// }) => {
//     // Logic for dynamic Tailwind classes
...
//     // Highlight logic: specifically used to make financial discrepancies pop in red
//     const totalColorClass = isHighlighted && typeof total === 'number' && total !== 0 
//         ? 'text-red-600' 
...
//                 <p className={`w-32 text-right font-bold ${totalColorClass}`}>
//                     {formatValue(total)}
//                 </p>
//             </div>
//         </div>
