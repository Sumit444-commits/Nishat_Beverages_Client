 ...
 * @param {Object} props
 * @param {string} props.activeView - The currently selected view name.
 * @param {Function} props.onNavigate - Callback function to change the current view.
 */
const Sidebar = ({ activeView, onNavigate }) => {
    // Array defining navigation structure; types removed
    const navItems = [
            ...
            <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                <ul>
                    {navItems.map((item) => {
                        ...
                        // Active logic remains the same; standard JS handles the comparison
                        ...
                        return (
                            <li key={item.name} className="relative group">
                                ...
                                >
                                    {/* JS handles cloning the element without generic checks */}
