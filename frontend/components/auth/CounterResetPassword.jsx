 ...
 */
const CounterResetPassword = ({ onBack, onSuccess }) => {
  ...
  useEffect(() => {
    // Check if there's a pending reset stored in the browser
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userIndex = users.findIndex((u) => u.id === pendingReset.userId);
      ...
      // Update user with new security credentials
      users[userIndex] = {
        ...users[userIndex],
        passwordHash,
        salt,
