...
// /**
//  * Main dashboard for counter staff to record on-site sales.
//  * @param {Object} props
...
//     // Persist database changes to localStorage
//     useEffect(() => {
//         saveDatabase(db);
//     }, [db]);

//     /**
//      * Session management logic to auto-logout expired counter sessions.
//      */
//     useEffect(() => {
//         const checkSession = () => {
...
//     /**
//      * Handles recording a new sale and updating inventory stock levels.
//      */
...
//     /**
//      * Shortcut for common bottle sales.
//      */
...
//     /**
//      * Reverses a sale and restores the associated stock.
//      */
...
//     // Filter sales to show only counter sales for the current date
...
const CounterView = ({ user, onLogout }) => {
    ...
    const getItemName = (sale) => {
        if (sale.description) return sale.description;
        if (sale.inventoryItemId) {
            const item = inventory.find(i => (i._id === sale.inventoryItemId || i.id === sale.inventoryItemId));
