...
// /**
//  * Modal component for editing existing expense records.
//  * @param {Object} props
//  * @param {boolean} props.isOpen - Controls visibility.
//  * @param {Function} props.onClose - Closes the modal.
//  * @param {Object|null} props.expense - The existing expense object to populate the form.
//  * @param {Function} props.onUpdateExpense - Callback to save changes.
...
//     // Prepares the list of available accounts for attribution
...
//         // Split the compound ID (e.g., "salesman-5") back into components
...
//                         <input type="text" id="edit-name" value={name} placeholder="e.g., Electricity Bill" onChange={e => setName(e.target.value)} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue sm:text-sm" />
//                     </div>
//                     <div>
...
//                         <select id="edit-paymentMethod" value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue sm:text-sm">
//                             <option>Cash</option>
//                             <option>Bank</option>
//                         </select>
//                     </div>
