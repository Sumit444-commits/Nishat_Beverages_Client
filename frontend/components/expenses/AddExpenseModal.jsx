...
//         // Parse the compound ID string (e.g. "salesman-5")
...
//                             <input
//                                 type="text"
//                                 placeholder="Create new owner (e.g., Shop Rent)"
//                                 value={newOwnerName}
...
//                         <input type="text" id="name" value={name} placeholder="e.g., Electricity Bill" onChange={e => setName(e.target.value)} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue sm:text-sm" />
//                     </div>
//                     <div>
...
//                         <select id="paymentMethod" value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue sm:text-sm">
