...
//  * @param {Array} props.sales - List of all sales to calculate totals.
...
//                                 #{index + 1}
//                             </span>
//                             <h3 className="font-bold text-lg text-brand-blue hover:underline truncate">
//                                 {customer.name}
//                             </h3>
//                         </div>
//                     </button>
...
//                     className="flex-1 text-xs bg-green-500 text-white px-2 py-1.5 rounded font-semibold hover:bg-green-600 transition-colors"
//                 >
//                     Sale
//                 </button>
//                 <button 
//                     onClick={() => onCollectEmpties(customer)} 
//                     className="flex-1 text-xs bg-blue-500 text-white px-2 py-1.5 rounded font-semibold hover:bg-blue-600 transition-colors"
//                 >
//                     Collect
//                 </button>
//                 <button 
//                     onClick={() => onViewDetails(customer)} 
//                     className="flex-1 text-xs bg-gray-500 text-white px-2 py-1.5 rounded font-semibold hover:bg-gray-600 transition-colors"
//                 >
//                     Details
//                 </button>
...
//                     className="p-1.5 text-brand-blue hover:bg-blue-100 rounded-full"
//                     title="Edit Customer"
//                 >
