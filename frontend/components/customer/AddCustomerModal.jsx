...
//                         <div>
//                             <label className="block text-sm font-medium text-brand-text-secondary mb-1">Frequency (Days) *</label>
//                             <input 
//                                 type="number" 
...
//                         <div>
//                             <label className="block text-sm font-medium text-brand-text-secondary mb-1">Initial Empty Bottles</label>
//                             <input 
//                                 type="number" 
//                                 value={emptyBottles} 
...
//                             onClick={onClose} 
//                             disabled={isLoading}
//                             className="px-6 py-2 bg-gray-100 text-brand-text-secondary rounded-md hover:bg-gray-200 font-semibold disabled:opacity-50"
//                         >
//                             Cancel
//                         </button>
//                         <button 
//                             type="submit" 
//                             disabled={isLoading}
//                             className="px-6 py-2 bg-brand-blue text-white rounded-md hover:bg-brand-lightblue font-semibold disabled:opacity-50 min-w-[120px]"
//                         >
