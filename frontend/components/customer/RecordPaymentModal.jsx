...
//                     <div>
//                         <label htmlFor="amount-paid" className="block text-sm font-medium text-brand-text-secondary">
//                             Amount Paid (PKR)
//                         </label>
//                         <input
//                             type="number"
...
//                     <div>
//                         <label htmlFor="payment-method-record" className="block text-sm font-medium text-brand-text-secondary">
//                             Payment Method
//                         </label>
//                         <select
...
//                         <button 
//                             type="submit" 
//                             className="px-4 py-2 bg-brand-blue text-white rounded-md hover:bg-brand-lightblue font-semibold"
//                         >
//                             Record Payment
//                         </button>
//                     </div>
